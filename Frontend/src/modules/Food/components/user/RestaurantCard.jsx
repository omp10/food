...
const RestaurantImageCarousel = React.memo(({ restaurant, priority = false, backendOrigin = "" }) => {
  ...
  return (
    ...
    >
      ...
      {restaurant.discount && (
        <div className="absolute top-2 left-0 px-2.5 py-1 bg-gradient-to-r from-blue-500 to-[#2979FB] text-white text-[10px] sm:text-xs font-black rounded-r-lg shadow-lg uppercase tracking-wider flex items-center gap-1">
