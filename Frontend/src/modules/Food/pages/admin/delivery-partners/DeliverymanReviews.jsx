        ...
        <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-4">
            <div className="flex items-center gap-3">
              <Star className="w-5 h-5 text-[#2979FB]" />
                ...
                <tbody className="bg-white divide-y divide-slate-100">
                  {filteredReviews.map((review) => (
                    <tr key={review.sl || review.orderId} className="hover:bg-slate-50 transition-colors">
                      ...
                      {visibleColumns.deliveryman && (
                        <td className="px-6 py-4 whitespace-nowrap">
                          <a href={`/admin/delivery-partners/${review.deliverymanId}`} className="text-sm font-medium text-[#2979FB] hover:text-blue-700">
                            {review.deliveryman}
                          </a>
                        </td>
                      )}
                      ...
                      {visibleColumns.customer && (
                        <td className="px-6 py-4 whitespace-nowrap">
                          <a href={`/admin/users/${review.customerId}`} className="text-sm font-medium text-[#2979FB] hover:text-blue-700">
                            {review.customer}
                          </a>
                        </td>
                      )}
            ...
            <div className="px-6 py-6 space-y-6">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-blue-50 rounded-lg p-4">
                  <p className="text-xs text-[#2979FB] mb-1">Deliveryman</p>
                  <a 
              ...
              <div className="bg-blue-50 rounded-lg p-4">
                <p className="text-xs text-[#2979FB] mb-2 font-semibold">Rating</p>
                <div className="flex items-center gap-3">
                  <div className="flex items-center gap-1">
                    {renderStars(selectedReview.rating)}
                  </div>
                  <span className="text-lg font-bold text-[#2979FB]">
