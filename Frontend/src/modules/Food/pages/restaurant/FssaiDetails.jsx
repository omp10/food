    ...
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <div className="flex-1 px-4 pt-4 pb-28 space-y-4">
        <div className="rounded-2xl bg-[#ffe9b3] px-4 py-3 flex items-start gap-3">
          <div
            className="mt-1 h-6 w-6 rounded-full flex items-center justify-center text-white text-xs font-semibold"
            style={{ backgroundColor: `${BRAND_THEME.colors.brand.primaryDark}cc` }}
          >
            i
          </div>
          <div className="flex-1">
