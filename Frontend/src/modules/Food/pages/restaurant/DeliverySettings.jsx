    ...
    <div className="min-h-screen bg-gray-100 flex flex-col">
        ...
        {showConfirmDialog && (
          <>
            ...
            <motion.div
              ...
              exit={{ opacity: 0 }}
              transition={{ duration: 0.2 }}
              className="fixed inset-0 bg-[#1E5ED8]/50 z-[100]"
      ...
      <AnimatePresence>
        {showSuccessToast && (
          ...
          >
            <div className="text-white px-4 py-3 rounded-lg shadow-2xl flex items-center gap-3 bg-gradient-to-r from-[#1E5ED8] to-[#3B82F6]">
